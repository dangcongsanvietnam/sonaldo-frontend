...
import { Badge, Breadcrumb, Button, Card, Checkbox, ConfigProvider, Drawer, Input, InputNumber, Modal, Pagination, Rate, Select, Slider, Spin } from "antd";
                ...
                <Breadcrumb
                    ...
                    items={[
                        ...
                        },
                        {
                            title: (
                                <span
                                    onClick={() => navigate(`/category/${categoryId}/${categoryItemId}`)}
                                    className="cursor-pointer text-sm text-[#1F4ABC] underline"
                                >
